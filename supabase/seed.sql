...
-- ---- VILLES — latitude/longitude = ENTRÉE ville (fin voyage 500 m), pas centre
insert into public.cities (id, name_fr, name_ar, region, latitude, longitude) values
  ('11111111-1111-1111-1111-000000000001','Nouakchott','نواكشوط','Nouakchott',18.0681,-15.9700),
  ('11111111-1111-1111-1111-000000000002','Nouadhibou','نواذيبو','Dakhlet Nouadhibou',20.9456,-17.0350),
  ('11111111-1111-1111-1111-000000000003','Rosso','روصو','Trarza',16.5223,-15.8109),
  ('11111111-1111-1111-1111-000000000004','Boghé','بوغي','Brakna',16.5925,-14.2756),
  ('11111111-1111-1111-1111-000000000005','Kaédi','كيهيدي','Gorgol',16.1487,-13.5110),
  ('11111111-1111-1111-1111-000000000006','Aleg','ألاك','Brakna',17.0522,-13.9179),
  ('11111111-1111-1111-1111-000000000007','Kiffa','كيفا','Assaba',16.6167,-11.4144),
  ('11111111-1111-1111-1111-000000000008','Aioun','العيون','Hodh El Gharbi',16.6610,-9.6204),
  ('11111111-1111-1111-1111-000000000009','Néma','النعمة','Hodh Ech Chargui',16.6126,-7.2579),
  ('11111111-1111-1111-1111-000000000010','Atar','أطار','Adrar',20.5146,-13.0550),
  ('11111111-1111-1111-1111-000000000011','Zouérat','الزويرات','Tiris Zemmour',22.7268,-12.4786),
  ('11111111-1111-1111-1111-000000000012','Sélibaby','سيليبابي','Guidimakha',15.1699,-12.1902),
  ('11111111-1111-1111-1111-000000000013','Tidjikja','تجكجة','Tagant',18.5421,-11.4415)
