    ...
    <div className="page max-w-2xl space-y-6">
      ...
      <div className="relative overflow-hidden rounded-3xl -mx-4 sm:mx-0 -mt-6 sm:-mt-2">
        ...
        <div className="relative px-5 sm:px-8 pt-8 pb-24 sm:pb-28 max-w-md">
          ...
          <span className="home-hero-badge mt-5 bg-white shadow-soft">
          ...
          {!user && (
            <div className="mt-5 flex flex-wrap items-center gap-2.5">
              <Link
                to="/login"
                className="inline-flex items-center justify-center gap-2 rounded-2xl px-5 py-3 font-semibold text-white bg-brand-600 hover:bg-brand-700 shadow-soft transition"
              >
              ...
              <Link
                to="/register"
                className="inline-flex items-center justify-center rounded-2xl px-5 py-3 font-semibold text-brand-700 bg-white ring-1 ring-brand-200 hover:bg-brand-50 shadow-soft transition"
              >
                {t("nav.register")}
              </Link>
            </div>
